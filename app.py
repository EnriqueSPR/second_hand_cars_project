...
def predict(years_old=4, km=20000, doors=5, location="Madrid", brand="Audi", horse_power=125, gear=0, seller=0, fuel=1, description_len=548):
    ...
    if request.method == 'POST':
        ...
        if output<0:
            ...
            return render_template('index.html',prediction_text="The estimated value for this second hand car is {} euros".format(output))
    else:
        return render_template('index.html')
...
if __name__=="__main__":
    app.run(debug=True)
>>>>>>> d4864826e20c508f3464d0f62de8185dcd5abdf7
=======
from flask import Flask, render_template, request
import jsonify
import requests
